...
function Header() {
    ...
    return (
        <div>
            <div className="grid grid-cols-6 space-x-2 px-20  pt-3 pb-3">
            ...
            <div className="grid grid-cols-6 px-20 pt-1 pb-1 bg-blue-500 text-white">
                <div className="flex justify-center items-center">
                    <span className="font-bold text-2xl">HuyHoangInterior</span>
                </div>
                <div className="col-start-2 col-end-7 px-20 pt-1 pb-1 justify-between items-center w-full md:flex md:w-auto md:order-1">
                    <ul className="flex flex-col pt-3 text-white md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        <Link
