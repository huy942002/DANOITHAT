...
function UpdateProductManage() {
    ...
    useEffect(() => {
        dispatch(getByIdProduct(idProduct));
        ...
        axios
            ...
            .then((response) => {
                ...
                if (index == 0) {
                    ...
                    toast.success('Update ảnh mới thành công', { autoClose: 2400 });
                } else if (index == 1) {
...
export default UpdateProductManage;